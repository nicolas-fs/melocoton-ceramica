...
export default function ProductCard({ producto }: { producto: Producto }) {
  const {
    titulo, slug, descripcionCorta, precio, precioOriginal,
    enPromocion, descuentoPorcentaje, imagenes, stock, destacado, categoria
  } = producto;
  ...
  return (
    <article className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md border border-melocoton-100 transition-all duration-300 group relative">
      ...
      {/* Imagen — usa img nativo para soportar base64 */}
      ...
      {/* Contenido */}
      <div className="p-4">
        <p className="font-sans text-xs text-melocoton-500 uppercase tracking-widest mb-1 capitalize">
          {categoria}
        </p>
        ...
        <div className="flex items-center justify-between gap-2">
          <div>
            <p className="font-serif text-xl font-medium text-tierra-900">
