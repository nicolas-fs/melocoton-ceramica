        ...
        <form onSubmit={submit} className="p-6 space-y-5">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl px-4 py-3">
            <p className="font-sans text-xs text-amber-700 leading-relaxed">
              ...
              WhatsApp y un email con el número de seguimiento. El estado pasará a <strong>Enviado</strong>.
            </p>
          </div>
...
function FilaPedido({
  ...
  // FIX: WhatsApp al cliente usa su numero real, no el de la tienda
  ...
  const waCliente = `https://wa.me/${telefonoCliente}?text=${mensajeWA}`;
    ...
    <div className={`bg-white rounded-2xl border shadow-sm overflow-hidden transition-all ${
      ...
      {open && (
        <div className="border-t border-gray-100 px-4 py-5 space-y-5 bg-gray-50/30">
          ...
          {/* Acciones rapidas */}
          <div className="flex flex-wrap gap-2">
            {/* FIX: WhatsApp va al numero real del CLIENTE, no al de la tienda */}
            <a href={waCliente} target="_blank" rel="noopener noreferrer"
              ...
              <MessageCircle className="w-3.5 h-3.5" /> WhatsApp al cliente ({pedido.cliente.telefono})
            </a>
