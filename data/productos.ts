...
export const CATEGORIAS = [
  ...
  { id: 'mates',          nombre: 'Mates',             emoji: '🧉', descripcion: 'Mates artesanales únicos' },
  { id: 'tazones-xl',     nombre: 'Tazones XL',        emoji: '🍵', descripcion: 'Desayunos que abrazan' },
  { id: 'mini-taza',      nombre: 'Mini Taza',         emoji: '🫖', descripcion: 'Pequeñas y adorables' },
  { id: 'portasahumerios',nombre: 'Portasahumerios',   emoji: '🌿', descripcion: 'Para aromatizar tu espacio' },
  { id: 'bowls',          nombre: 'Bowl',              emoji: '🥣', descripcion: 'Ensaladas y más' },
  { id: 'cazuelas',       nombre: 'Cazuelas',          emoji: '🍲', descripcion: 'Para el horno y la mesa' },
  { id: 'sets',           nombre: 'Sets',              emoji: '🎁', descripcion: 'El regalo perfecto' },
  { id: 'bandejas',       nombre: 'Bandejas',          emoji: '🫙', descripcion: 'Para servir con estilo' },
  { id: 'platos',         nombre: 'Platos',            emoji: '🍽️', descripcion: 'Para tu mesa cotidiana' },
  { id: 'te-para-uno',    nombre: 'Té p/ uno',         emoji: '🫗', descripcion: 'Tetera y taza en uno' },
  { id: 'otros',            nombre: 'Otros',             emoji: '', descripcion: 'Piezas especiales' },
  { id: 'fechas-especiales', nombre: 'Fechas Especiales', emoji: '', descripcion: 'Dia de la madre, cumpleanos, aniversarios' },
  { id: 'tazas-con-frases',  nombre: 'Tazas con Frases',  emoji: '', descripcion: 'Con mensajes pintados a mano' },
];
