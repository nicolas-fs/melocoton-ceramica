...
const nextConfig = {
  // Permite build exitoso en Vercel aunque Prisma genere warnings de tipos
  typescript: { ignoreBuildErrors: false },
  experimental: {
    // Necesario para Prisma en Edge runtime si se usa
  ...
  images: {
    ...
    unoptimized: true  // local images in /public/images/,
  },
